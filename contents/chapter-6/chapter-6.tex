...
DFIG-WT memicu ketidakstabilan. Integrasi DFIG-WT juga mempersempit margin
kestabilan beban: batas ketidakstabilan Beban B turun dari 373\%
menjadi 86\%, dan Beban A dari 247\% menjadi 63\%. Nilai DR pada batas
ketidakstabilan ($-$10,60\% dan $-$7,42\%) jauh lebih negatif dibandingkan sistem
konvensional, menandakan DFIG-WT kehilangan kestabilan lebih cepat.
...
\textit{fully-rated converter} memisahkan dinamika mesin dari jaringan. Margin
kestabilan beban dengan PMSG-WT lebih baik dibandingkan DFIG-WT, namun bergantung
pada konfigurasi: pada peningkatan Beban B sebesar 237\%, sistem dengan PMSG-WT
menggantikan G3 (Skenario 5.1) tepat berada di batas ketidakstabilan (DR =
$-$0,63\%), sementara sistem dengan PMSG-WT menggantikan G2 (Skenario 5.2) masih
stabil pada peningkatan Beban A yang sama dengan DR = 8,39\%.
...
mendominasi pada Skenario 4.1 dan 4.2, sedangkan $\omega$ G1 mendominasi pada
skenario PMSG-WT (5.1) maupun skenario konvensional (1.2, 1.3), mengonfirmasi
bahwa \textit{fully-rated converter} PMSG-WT mencegah dinamika mesin
berpartisipasi dalam mode tidak stabil.
